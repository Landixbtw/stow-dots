...
beautiful.font = "JetBraisMono Nerd Font 11"
...
awful.key({ modkey, "Control" }, "r", awesome.restart, { description = "reload awesome", group = "awesome" }),
	...
	awful.key({ modkey, "Shift" }, "s", function()
		awful.spawn.with_shell("flameshot gui -c -p ~/Pictures/Screenshots/")
	end, { description = "Brings up a menu to take screenshot", group = "custom" }),
    ...
    -- awful.key({ modkey }, "d", function ()
    --     awful.spawn.with_shell("dmenu_run -i")
    -- end, { description = "Open Dmenu", group = "custom"})
...
-- set screens 
awful.spawn.with_shell("xrandr --output DP-2 --mode 1920x1080 --rate 164.92 --pos 0x0 --primary")
awful.spawn.with_shell("xrandr --output DP-4 --mode 1920x1080 --rate 164.92 --pos 1920x0")
